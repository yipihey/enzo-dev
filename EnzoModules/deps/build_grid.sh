...
for src in Grid_EnzoModulesFixture enzomodules_grid_bridge enzomodules_problem_bridge; do
...
${CXX} -shared -fPIC -o "${out}" \
    "${here}/Grid_EnzoModulesFixture.o" "${here}/enzomodules_grid_bridge.o" "${here}/enzomodules_problem_bridge.o" \
    -L"${enzo_src}" -l"${libname}" -lhdf5_serial -lz -lgfortran \
    -Wl,-rpath,"${enzo_src}"
rm -f "${here}/Grid_EnzoModulesFixture.o" "${here}/enzomodules_grid_bridge.o" "${here}/enzomodules_problem_bridge.o"
