...
const ROWS = GateRow[
    ...
    GateRow("gravity", "Gravity solver registry", "lib/PowerFoam/examples/arepo_gravity_solver_registry_smoke.jl",
            "D1", "examples/out/arepo_gravity_solver_registry_smoke/.../README.md",
            "direct, PM, tree, cosmological PM, and coupled gravity readiness table"),
