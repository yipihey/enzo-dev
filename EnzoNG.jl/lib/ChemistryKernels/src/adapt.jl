...
function Adapt.adapt_structure(to, net::GenericNetwork{IM,RM,T}) where {IM,RM,T}
    ...
    return GenericNetwork{typeof(reac),typeof(rate),T}(net.nspec, net.nreac, reac, prod, rate, net.grid)
end
...
function Adapt.adapt_structure(to, rt::RateTables{T}) where {T}
    ...
    return RateTables{T,typeof(a(rt.k1))}(rt.grid,
        ...
        a(rt.k50),a(rt.k51),a(rt.k52),a(rt.k53),a(rt.k54),a(rt.k55),a(rt.k56),
